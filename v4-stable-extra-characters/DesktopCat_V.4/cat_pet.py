...
class DesktopCat(Gtk.Window):
    ...
    def _load_sources(self):
        for color in ("black", "white", "charizard", "penguin", "popbot_blue", "popbot_white"):
    ...
    def _menu(self, event):
        ...
        simple("Charizard",   lambda w: self._set_color("charizard"))
        simple("Penguin",     lambda w: self._set_color("penguin"))
        simple("Pop bot (blue)",  lambda w: self._set_color("popbot_blue"))
        simple("Pop bot (white)", lambda w: self._set_color("popbot_white"))
